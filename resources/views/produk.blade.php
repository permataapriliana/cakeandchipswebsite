            ...
            <table class="table table-striped">
                ...
                @foreach($listUser as $data)
                    <tr>
                        ...
                        <td>
                         <a href="{{url('edit-produk')}}" data-toggle="tooltip" data-placement="top" onclick="GetData('1')" title="" data-original-title="Edit">
                            <span class="badge badge-success">Edit</span>
                          </a>
                        
                          <a href="#" data-toggle="tooltip" data-placement="top" onclick="DeleteData('1')" title="" data-original-title="Delete">
